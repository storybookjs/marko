...
const COMPONENT_META_PARAMETERS =
  'if(componentMeta) componentMeta.parameters = { ...(componentMeta.parameters || {}), storySource: { source: __STORY__, locationsMap: __ADDS_MAP__ } };';
