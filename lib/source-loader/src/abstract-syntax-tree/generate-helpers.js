...
const COMPONENT_META_PARAMETERS = `if(typeof componentMeta !== 'undefined'  && componentMeta) componentMeta.parameters = { ...(componentMeta.parameters || {}), storySource: { source: __STORY__, locationsMap: __ADDS_MAP__ } };`;
...
export function generateSourceWithDecorators(source, ast, withParameters) {
  ...
  const newSource =
    ...
    partsUsingExports
      ...
      .join('') +
    (withParameters ? COMPONENT_META_PARAMETERS : '');
