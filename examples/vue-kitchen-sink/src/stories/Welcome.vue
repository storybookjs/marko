<template>
  <div class="main">
    ...
    <p>This is a UI component dev environment for your vue app.</p>
    <p>
      We've added some basic stories inside the
      <code class="code">src/stories</code>
      directory. A story is a single state of one or more UI components.
    </p>
    ...
    <p>
      ...
      <br>(Try editing the
      <code class="code">Button</code> component
      located at
