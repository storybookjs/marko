...
import { testStory } from "../../setup";

testStory("can increment counter", async (page) => {
...
//     await fs.promises
//       .mkdir("coverage/tmp", { recursive: true })
//       .catch(() => {});

//     const result: typeof coverage = [];
...
//         await fs.promises.writeFile(filename, entry.source);
